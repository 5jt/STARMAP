...
Each conversation starts without memory of previous sessions. Follow this workflow:

**Session start:**
1. Read `CLAUDE.md` (this file)
2. Read `plans/TODO.md` for current status
3. Read `plans/PLAN.md` if phase context needed
4. Read relevant source files for the task at hand

**Session end:**
1. Update `plans/TODO.md` with:
   - Session log entry (date and summary of work done)
   - Move completed items to Completed section
   - Update Active tasks and Up next as needed
   - Note any new blockers
   - Record the session conversation in logs/conversation-{timestamp}
2. Commit progress if appropriate

**Wrap-up trigger:** When the user says "let's wrap up", "end session", or similar, perform the Session End actions.
